...
const PDF_FILENAME = "Alpine_The_Carvana_Case.pdf";
const PDF_PATH = path.join(process.cwd(), "public", "the-carvana-case.pdf");
  ...
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;">
    ...
    <div style="padding:32px 32px 24px;">
      ...
      <p style="font-size:14px;color:#475569;line-height:1.7;margin:0 0 14px;">
        Thank you for your interest. Attached is your personal copy of <strong>The Carvana Case</strong> — Alpine's ODD case study on why operational due diligence matters before the fraud becomes obvious.
      </p>
      <p style="font-size:14px;color:#475569;line-height:1.7;margin:0 0 14px;">
      ...
      <div style="margin:24px 0;padding:16px 18px;background:#f8f7f4;border-left:3px solid #7c3aed;border-radius:4px;">
        ...
        <div style="font-size:13px;color:#475569;line-height:1.8;">
          <div><span style="color:#94a3b8;">Title:</span> The Carvana Case</div>
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      from: FROM_EMAIL,
      to: rawEmail,
      subject: "Your copy of The Carvana Case — Alpine Due Diligence",
    ...
    try {
      await supabase.from("watermark_distributions").insert({
        ...
        distributed_by: "carvana-case-self-serve",
        email_sent: true,
      });
    } catch (logErr) {
    ...
    console.error("Carvana download error:", err);
