...
const PUBLICATIONS = [
  ...
  {
    category: "Case Study",
    title: "Aurora Ventures IV, L.P.",
    description:
      "How Alpine's 8-chapter ODD framework identified headline governance risk and post-close monitoring requirements for a leading early-stage VC fund.",
    href: "#",
    cta: "Coming soon",
    available: false,
  },
