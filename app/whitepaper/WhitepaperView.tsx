...
export default function WhitepaperView({ isPrint = false }: { isPrint?: boolean }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: isPrint ? "#ffffff" : "#ebebeb" }}>
      ...
      {/* ── Content ────────────────────────────────────────────────────────── */}
      <div style={{ flex: 1, userSelect: "none", padding: isPrint ? "0" : "0 16px 64px" }}>
